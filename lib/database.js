...
class Database {
  constructor() {
    this.pool = new Pool({
      host: process.env.POSTGRES_HOST || '144.91',
      port: process.env.POSTGRES_PORT || 30035,
      database: process.env.POSTGRES_DB || 'alya',
      user: process.env.POSTGRES_USER || 'alya',
      password: process.env.POSTGRES_PASSWORD || 'Alya@',
      max: 20,
    })
