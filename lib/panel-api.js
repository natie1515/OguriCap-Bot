...
import notificationSystem, { sendNotification, sendTemplateNotification, NOTIFICATION_TYPES, NOTIFICATION_CATEGORIES } from './notification-system.js'
  ...
  panelServer = http.createServer(async (req, res) => {
    try {
      ...
      if (pathname === '/api/subbots/qr' && method === 'POST') {
        ...
        // Plugin system removido - funcionalidad simulada
        // const { yukiJadiBot } = await import('../plugins/sockets-serbot.js')
        // Simulación de resultado para QR
        const qrData = {
          success: false,
          error: 'Plugin system removido - funcionalidad simulada'
        }
        
        // Código comentado del plugin system:
        /*
      ...
      if (pathname === '/api/subbots/code' && method === 'POST') {
        ...
        // Plugin system removido - funcionalidad simulada
        // const { yukiJadiBot } = await import('../plugins/sockets-serbot.js')
        // Simulación de resultado para pairing code
        const result = {
          success: false,
          error: 'Plugin system removido - funcionalidad simulada'
        }
      ...
      if (pathname === '/api/notifications' && method === 'GET') {
        ...
        const notifications = await notificationSystem.getNotifications({ page, limit, category })
        ...
        try {
          ...
          const exportData = {
            ...
            data: {
              ...
              notifications: await notificationSystem.getNotifications({ limit: 1000 }),
